...
type ACMEChallengeSolverHTTP01GatewayHTTPRoute struct {
	...
	ParentRefs []v1alpha2.ParentReference `json:"parentRefs"`
}
...
func (in *ACMEChallengeSolverHTTP01GatewayHTTPRoute) DeepCopyInto(out *ACMEChallengeSolverHTTP01GatewayHTTPRoute) {
	*out = *in
	...
	if in.ParentRefs != nil {
		l := make([]v1alpha2.ParentReference, len(in.ParentRefs))
...
type ACMEIssuerDNS01ProviderRoute53 struct {
	...
	// vars, shared credentials file or AWS Instance metadata,
	// see: https://docs.aws.amazon.com/sdk-for-go/v1/developer-guide/configuring-sdk.html#specifying-credentials
	SecretAccessKeyID *metav1_1.SecretKeySelector `json:"accessKeyIDSecretRef,omitempty"`
