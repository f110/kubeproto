...
var file_kube_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x73, 0x52, 0x03, 0x6b, 0x38, 0x73, 0x3a, 0x58, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x18, 0xea, 0xd4, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x64,
	0x65, 0x76, 0x2e, 0x66, 0x31, 0x31, 0x30, 0x2e, 0x6b, 0x75, 0x62, 0x65, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2e, 0x45, 0x6e, 0x75, 0x6d, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c,
...
var file_kube_proto_depIdxs = []int32{
	...
	9,  // 5: dev.f110.kubeproto.value:extendee -> google.protobuf.EnumValueOptions
	1,  // 6: dev.f110.kubeproto.kind:type_name -> dev.f110.kubeproto.Kind
	2,  // 7: dev.f110.kubeproto.field:type_name -> dev.f110.kubeproto.Field
	3,  // 8: dev.f110.kubeproto.k8s:type_name -> dev.f110.kubeproto.Kubernetes
	5,  // 9: dev.f110.kubeproto.value:type_name -> dev.f110.kubeproto.EnumValue
