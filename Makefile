...
gen-object: go/apis/metav1/metav1_kubeproto.generated.object.go \
	...
	go/apis/admissionregistrationv1/admissionregistrationv1_kubeproto.generated.object.go \
...
go/k8sclient/go_client.generated.client.go: gen-proto gen-object
	@mkdir -p $(@D)
...
go/k8stestingclient/go_testingclient.generated.testingclient.go: gen-proto gen-object
	@mkdir -p $(@D)
