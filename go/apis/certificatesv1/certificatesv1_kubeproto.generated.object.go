...
const (
	RequestConditionTypeApproved RequestConditionType = "Approved"
	RequestConditionTypeDenied   RequestConditionType = "Denied"
	RequestConditionTypeFailed   RequestConditionType = "Failed"
)
...
func (in *CertificateSigningRequestList) DeepCopyInto(out *CertificateSigningRequestList) {
	*out = *in
	...
	if in.Items != nil {
		l := make([]CertificateSigningRequest, len(in.Items))
...
func (in *CertificateSigningRequestStatus) DeepCopyInto(out *CertificateSigningRequestStatus) {
	*out = *in
	if in.Conditions != nil {
		l := make([]CertificateSigningRequestCondition, len(in.Conditions))
